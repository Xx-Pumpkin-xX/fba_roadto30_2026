...
data/raw/                             place the input dataset here (download link in "How to run")
...
# download the dataset (link below) and save it as data/raw/FBAR2_TEAM_B_DATASET_v2.xlsx
jupyter nbconvert --to notebook --execute --inplace notebook/B1_axis2_supply_side.ipynb
```

Input dataset (Team B, updated 26/09/2026): [Google Drive](https://docs.google.com/spreadsheets/d/1PDUMdbFhzxsQhsgBQDzx3zAFrQuUdy7G/edit?usp=drive_link&ouid=109676688998992381776&rtpof=true&sd=true). Download it as .xlsx and save it as `data/raw/FBAR2_TEAM_B_DATASET_v2.xlsx`.
...
- The input dataset is shared through the Drive link above rather than stored in the repo.
